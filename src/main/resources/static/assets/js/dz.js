...
dsy.add("0_22_0", ["青羊区", "锦江区", "金牛区", "武侯区", "成华区", "高新区", "龙泉驿区", "青白江区", "新都区", "温江区", "都江堰市", "彭州市", "邛崃市", "崇州市", "金堂县", "双流县", "郫县", "大邑县", "蒲江县", "新津县", "其它"]);
...
dsy.add("0_34", ["其它"]);
dsy.add("0_34_0", ["其它"]);
dsy.add("0", ["北京市", "天津市", "上海市", "重庆市", "河北省", "山西省", "内蒙古", "辽宁省", "吉林省", "黑龙江省", "江苏省", "浙江省", "安徽省", "福建省", "江西省", "山东省", "河南省", "湖北省", "湖南省", "广东省", "广西", "海南省", "四川省", "贵州省", "云南省", "西藏", "陕西省", "甘肃省", "青海省", "宁夏", "新疆", "香港", "澳门", "台湾省", "其它"]);
var s2 = ["x_province", "x_city", "x_county"];
var opt02 = ["-选择省-", "-选择市-", "-县或区-"];
