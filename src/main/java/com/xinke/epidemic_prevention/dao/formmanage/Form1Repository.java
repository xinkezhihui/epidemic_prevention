...
public interface Form1Repository extends JpaRepository<FormOne,Integer>, JpaSpecificationExecutor<FormOne> {
    //查询0-12时疑似——当日新增

    @Query(value = "SELECT  ifnull(COUNT(*),0) from yq_bldjb where yq_yszdrq> ?1'00:00:00' and yq_yszdrq< ?1'12:00:00' and xzxq='泰山区' ",nativeQuery=true)
    ...
    //当日新增确诊
    @Query(value = "SELECT  ifnull(COUNT(*),0) from yq_bldjb where yq_qzsj> ?1'00:00:00' and yq_qzsj< ?1'12:00:00' and xzxq='泰山区' ",nativeQuery=true)
    ...
    //确诊-出院病例-当日新增
    @Query(value = "SELECT  ifnull(COUNT(*),0) from yq_bldjb where yq_sfqz=1 and yq_sfcy=1 and yq_chuysj>?1'00:00:00' and yq_chuysj<?1'12:00:00' and xzxq='泰山区' ",nativeQuery=true)
    ...
    //确诊-死亡-当日新增
    @Query(value = "SELECT  ifnull(COUNT(*),0) from yq_bldjb where yq_sfqz=1 and yq_sfsw=1 and swsj>?1'00:00:00' and swsj<?1'12:00:00' and xzxq='泰山区' ",nativeQuery=true)
    ...
    public int mjfyw();
    //密接-当日解除
    @Query(value = "SELECT  ifnull(COUNT(*),0)  from yq_bldjb where  yq_sfpc=1 and qrmjsj>?1'00:00:00' and qrmjsj<?1'12:00:00'  and xzxq='泰山区' ",nativeQuery=true)
    ...
    public int ljmj();*/
    //密接-当日诊断为疑似或确诊
    @Query(value = "SELECT  ifnull(COUNT(*),0)  from yq_bldjb where qrmjsj>?1'00:00:00' and qrmjsj<?1'12:00:00'and xzxq='泰山区' and (yq_sfys=1 or yq_sfqz=1) ",nativeQuery=true)
